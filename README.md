...
Search is designed to set up and manage a particular master data type such as
trading-partners
...
- If both are included along with additional search keys, but no `exact` matches
  are returned, it will fall back to a fuzzy search.
